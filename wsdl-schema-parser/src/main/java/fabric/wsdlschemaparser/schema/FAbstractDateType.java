...
public abstract class FAbstractDateType extends FSimpleType {
    ...
    public List<Integer> getValidFacets() {
        ...
        return Arrays.asList(new Integer[] { SchemaType.FACET_MIN_INCLUSIVE, SchemaType.FACET_MIN_EXCLUSIVE,
                SchemaType.FACET_MAX_INCLUSIVE, SchemaType.FACET_MAX_EXCLUSIVE, });
    }
